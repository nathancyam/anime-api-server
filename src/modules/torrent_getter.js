 ...
 * @returns {string}
 */
TorrentGetter.prototype.formatSearchString = function (title, subgroup, ep) {
 ...
 */
TorrentGetter.prototype.getSearchResults = function () {
    var self = this;

    self.getSearchQueries()
        .then(function (results) {
            return results.map(function (query) {
                return Q.denodeify(self.ntSearch.bind(self))({ term: query });
            });
        }).then(function (promises) {
            return Q.allSettled(promises);
        }).then(function (results) {
 ...
 * @returns {*}
 */
TorrentGetter.prototype.parseSearchResults = function (results) {
